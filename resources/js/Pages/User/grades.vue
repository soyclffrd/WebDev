...
const dashboardIcon = '/Assets/img/img-grades/vuesax-broken-home-2-5.svg';
const gradesIcon = '/Assets/img/img-grades/vuesax-outline-grade.svg';
const classesIcon = '/Assets/img/img-grades/vuesax-outline-class.svg'; // Add your classes icon here
...
const filteredGrades = computed(() => {
    return props.grades.filter(gradeItem => {
        return (
            gradeItem.instructor.toLowerCase().includes(searchQuery.value.toLowerCase()) ||
            gradeItem.subject.toLowerCase().includes(searchQuery.value.toLowerCase()) ||
            gradeItem.grade.toString().includes(searchQuery.value)
        );
    });
});

const openModal = (gradeItem = null) => {
    if (gradeItem) {
        form.id = gradeItem.id;
        form.instructor = gradeItem.instructor;
        form.subject = gradeItem.subject;
        form.grade = gradeItem.grade;
...
const submitForm = () => {
    ...
    const url = isEditing.value ? `/grades/${form.id}/update` : '/grades';
    ...
    form[method](url, {
        ...
        onSuccess: () => {
            ...
            Swal.fire({
                title: 'Success!',
                text: isEditing.value ? 'Grade updated successfully' : 'Grade added successfully',
                icon: 'success',
                ...
                <div class="overlap-7">
                    ...
                    <div class="frame-4">
                        ...
                        <Link href="/user/class">
                            <div class="frame-wrapper">
                                <div class="frame-6">
                                    <img class="img-2" :src="classesIcon" alt="Classes Icon" />
                        ...
                        <div class="subjectsfinal active">
                            <div class="frame-wrapper">
                                <div class="frame-6">
                                    <img class="img-2" :src="gradesIcon" alt="Grades Icon" />
            ...
            <div class="frame-2">
                <div class="table-container">
                    ...
                    <div class="table-body">
                        <div v-for="gradeItem in filteredGrades" :key="gradeItem.id" class="table-row">
                            <div class="table-cell">{{ gradeItem.instructor }}</div>
                            <div class="table-cell">{{ gradeItem.subject }}</div>
                            <div class="table-cell">{{ gradeItem.grade }}</div>
                            <div class="table-cell actions">
                                <button class="edit-btn" @click="openModal(gradeItem)">Edit</button>
                                <button class="delete-btn" @click="deleteGrade(gradeItem.id)">Delete</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <form @submit.prevent="submitForm">
                        <div class="form-group">
                            ...
                            <input type="text" id="instructor" v-model="form.instructor" required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="grade" v-model="form.grade" required />
                        </div>
