                ...
                <div class="sidebar-menu">
                    <div class="overlap-7">
                        ...
                        <div class="frame-4">
                            ...
                            <div class="sectionsfinal active">
                                <div class="frame-wrapper">
                                    <div class="frame-6">
...
const sectionIcon = '/Assets/img/img-teach/section-icon.svg'; // Add your section icon here
...
.sectionsfinal.active .frame-wrapper {
    background-color: #3182ce;
}

.sectionsfinal.active .text-wrapper-17 {
    color: #ffffff;
}

.sectionsfinal.active .img-2 {
