                ...
                <div class="sidebar-menu">
                    <div class="overlap-7">
                        ...
                        <div class="frame-4">
                            ...
                            <div class="teachersfinal active">
                                <div class="frame-wrapper">
                                    <div class="frame-6">
                ...
                <div class="frame-2">
                    <div class="table-container">
                        ...
                        <div class="table-body">
                            <div v-for="teacher in filteredTeachers" :key="teacher.id" class="table-row">
                                <div class="table-cell">
                                    <div class="teacher-info">
                                        <img 
                                            :src="teacher.image ? teacher.image : '/Assets/img/img-teach/default-avatar.png'" 
                                            :alt="teacher.name"
                                            class="teacher-image"
                                        >
                                ...
                                <div class="table-cell">{{ teacher.subject ? teacher.subject.name : 'No Subject Assigned' }}</div>
                                <div class="table-cell actions">
                                    <button class="edit-btn" @click="openModal(teacher)">Edit</button>
...
const submitForm = () => {
    if (isEditing.value) {
        form.post(`/admin/teacher/${form.id}/update`, {
            onSuccess: () => {
