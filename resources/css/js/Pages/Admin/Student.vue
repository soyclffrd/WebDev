                    ...
                    <div class="table-container">
                        ...
                        <div class="table-body">
                            <div v-for="student in filteredItems" :key="student.id" class="table-row">
                                ...
                                <div class="table-cell">{{ student.section }}</div>
...
const submitForm = () => {
    ...
    form.post(url, {
        ...
        onSuccess: () => {
            ...
            Swal.fire({
                title: 'Success!',
                text: `Student ${isEditing.value ? 'updated' : 'added'} successfully`,
                icon: 'success',
                timer: 2000,
                showConfirmButton: false,
                position: 'top',
...
const validateForm = () => {
    if (!form.name || !form.email || !form.grade_id || !form.strand_id || !form.section || !form.gender) {
        Swal.fire({
            title: 'Error!',
