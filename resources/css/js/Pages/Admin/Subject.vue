                    ...
                    <div class="table-container">
                        ...
                        <div class="table-body">
                            <div v-for="subject in filteredSubjects" :key="subject.id" class="table-row">
                                ...
                                <div class="table-cell">{{ subject.grade ? `Grade ${subject.grade.level}` : 'No Grade' }}</div>
                                <div class="table-cell">{{ subject.strand ? subject.strand.name : 'No Strand' }}</div>
